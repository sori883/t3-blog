...
export const Footer = () => {
  return (
    <div>
      <footer className="ui_footer text-base-content bg-white p-10">
        <nav>
      ...
      <footer className="ui_footer text-base-content border-base-300 border-t bg-white px-10 py-4">
